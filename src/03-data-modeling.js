...
//                 Example: One specific book = { title: "Dune", author: "Frank Herbet"}
...
//
console.log('=== 3. Object and Array as data modeling ===\n');
...
console.log(`\n4) books currently available: ${availableBooks.length}`);
availableBooks.forEach(book => {
    console.log(`   ${book.title}`);
});

// -------- 5) map: Creates a NEW array by transforming each item --------
...
// -------- 7) reduce: Combine all items into a one value --------
...
console.log(`   grade: ${studentRecord.grades.join(', ')}`);
